      ...
      <div className="bg-accent/20">
        <div className="max-w-[1320px] grid grid-cols-1 gap-6 sm-text-center sm:grid-cols-2 lg:grid-cols-3 px-12 ">
          {FetureData.map((card, index) => (
            <div
              key={index}
              className="my-6 bg-white   border  border-gray-300 dark:border-gray-700 border-transparent  hover:border-gray-500 hover:border-dotted"
            >
              <div className="h-[225px] overflow-hidden  relative">
                ...
                />
                <span className="absolute top-0 left-0 bg-red-500 m-2 p-2 text-[15px] font-semibold text-white ">
                  Sale
                </span>
              </div>
              <div className="pt-4 pb-2  border-gray-300">
                <div className="flex ">
                  <span className="inline-block py-1 text-[12px] font-semibold  p-5  text-gray-500 mb-2 text-left">
                    <i class="fa-solid fa-ruler-combined mx-2 text-red-500"></i>
                    {card.squre}
                  </span>
                  <span className="inline-block  py-1 text-[12px] font-semibold  p-5  text-gray-500 mb-2 text-left">
                  ...
                  <span className="inline-block py-1 text-[12px] font-semibold  p-5  text-gray-500  mb-2 text-left">
                    <i class="fa-solid fa-bath mx-2 text-red-500"></i>{" "}
                    {card.bathrooms}{" "}
                  </span>
                </div>
              </div>
              ...
              <p className="mb-3 font-[18px] mx-4 text-gray-500 dark:text-gray-400 text-left">
                {card.location}
              </p>
